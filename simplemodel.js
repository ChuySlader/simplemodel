    ...
    this.validator = function (fields, domObjects) {
        ...
        if (validators.indexOf("default") !== -1) {
            ...
            for (i in domObjects) {
                ...
                if (ref.hasClass("border-error")) {
                    ref.removeClass("border-error");
                }
                if (ref.hasClass("border-warning")) {
                    ref.removeClass("border-warning");
                }
            ...
            if (parent.properties.fields[input.attr("name")] !== undefined) {
                ...
                if (input.attr('type') === "checkbox" || input.attr('type') === "radio") {
                    ...
                    if (input.attr("value") === '' || input.attr("value") === undefined) {
                        if (parent.properties.fields[input.attr("name")].
                            default !== undefined) {
                            Instance.data[input.attr("name")] = parent.properties.fields[input.attr("name")].
                            default;
                        }
                    }
                    input.change(onchange);
